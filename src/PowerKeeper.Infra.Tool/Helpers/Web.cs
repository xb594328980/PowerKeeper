...
using PowerKeeper.Infra.Tool.Security.Principals;
...
namespace PowerKeeper.Infra.Tool.Helpers
{
    ...
    public static class Web
    {
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static PowerKeeper.Infra.Tool.Webs.Clients.WebClient Client()
        {
            return new PowerKeeper.Infra.Tool.Webs.Clients.WebClient();
        }
        ...
        public static PowerKeeper.Infra.Tool.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class
        {
            return new PowerKeeper.Infra.Tool.Webs.Clients.WebClient<TResult>();
        }
