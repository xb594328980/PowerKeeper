...
using PowerKeeper.Infra.Tool.Logs.Extensions;
...
namespace PowerKeeper.Infra.Data.Log
{
    ...
    public class EfLog : ILogger
    {
        ...
        protected virtual ILog GetLog()
        {
            try
            {
                return PowerKeeper.Infra.Log.Log.GetLog(TraceLogName);
            }
            catch
            {
        ...
        protected virtual UnitOfWork GetUnitOfWork()
        {
            try
            {
                var result = Ioc.Create<IUnitOfWork>();
                return result as UnitOfWork;
            }
            catch
            {
                return null;
